...
public class dbCreationHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_SERIALES ="CREATE TABLE IF NOT EXISTS Seriales(id_serial INTEGER PRIMARY KEY AUTOINCREMENT, codigoArticulo TEXT, serial TEXT, tipoComprobante TEXT, id_item INTEGER, FOREIGN KEY(id_item) REFERENCES Item(id_item) ON DELETE CASCADE);";
